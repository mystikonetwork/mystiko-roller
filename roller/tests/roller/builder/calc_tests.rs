...
use mystiko_roller::roller::{calc_rollup_size_queue, circuit_type_from_rollup_size};
use mystiko_types::CircuitType;

#[tokio::test]
async fn test_circuit_type_from_rollup_size() {
    assert_eq!(CircuitType::Rollup1, circuit_type_from_rollup_size(1).unwrap());
    assert_eq!(CircuitType::Rollup2, circuit_type_from_rollup_size(2).unwrap());
...
#[tokio::test]
async fn test_calc_rollup_size_array_0() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_1() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_2() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_3() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_4() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_5() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_6() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_7() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_8() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_9() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_10() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_11() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_12() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_13() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_14() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![2]),
        (3, vec![2]),
...
#[tokio::test]
async fn test_calc_rollup_size_array_15() {
    let test_cases = vec![
        (1, vec![1]),
        (2, vec![1]),
        (3, vec![1, 2]),
